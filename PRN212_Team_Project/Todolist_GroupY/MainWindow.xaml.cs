...
namespace Todolist_GroupY
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (selected == null)
            {
                MessageBoxWindow.Show("Please select a row before deleting", "Select one", MessageBoxButton.OK);
                return;
            }

            MessageBoxResult answer = MessageBoxWindow.Show("Are you sure?", "Confirm", MessageBoxButton.YesNo);
        ...
        private void ViewDetailButton_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            if (selected == null)
            {
                MessageBoxWindow.Show("Please select a row before view detail", "Select one", MessageBoxButton.OK);
                return;
            }
        ...
        private void UpdateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (selected == null)
            {
                MessageBoxWindow.Show("Please select a row before update", "Select one", MessageBoxButton.OK);
                return;
            }
